...
- Header: full-width artist photo at the top (the largest image from step 4), width 600px, height auto, then a 4px solid #111111 bar, then the title "${artistName} - Weekly Report" in bold 22px #111111 with the date range in 13px #6B7280 underneath.
