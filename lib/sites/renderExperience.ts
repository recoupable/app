...
[hidden]{display:none!important}body[data-preview="false"] header{display:none}.entrance{position:fixed;inset:0;z-index:20;background:rgb(9 13 23 / 48%);backdrop-filter:blur(6px)}.music-panel{position:fixed;right:39px;top:14px;width:375px;z-index:30;border-radius:12px;overflow:hidden;box-shadow:#dcdcdc 0 0 0 .5px inset,0 6px 10px #00000026;background:white;color:#1f1a1e}.music-panel iframe{height:260px;min-height:0;width:100%;border:0}.music-panel.collapsed{visibility:hidden;pointer-events:none;transform:translateX(calc(100% + 40px))}.music-toggle{position:fixed;right:0;top:50px;z-index:31;background:#171717;color:white;width:48px;height:48px;border-radius:14px 0 0 14px;padding:0;display:flex;align-items:center;justify-content:center;box-shadow:0 0 0 1px #ffffff1a,0 4px 16px #0003;transition:background .15s ease}.music-toggle:hover{background:#303030}.music-toggle:focus-visible{outline:2px solid white;outline-offset:3px}.music-toggle svg{display:block}.music-panel:not(.collapsed)~.music-toggle{display:none}#experience[inert]{pointer-events:none}@media(max-width:640px){.music-panel{top:auto;bottom:0;right:0;width:100%;border-radius:12px 12px 0 0}.music-panel.collapsed{transform:translateY(100%)}}
